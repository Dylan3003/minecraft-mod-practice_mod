package net.airmandn.practicemod.world.feature;
...
public class ModConfiguredFeatures {
    public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES =
            DeferredRegister.create(Registry.CONFIGURED_FEATURE_REGISTRY, practicemod.MOD_ID);
    ...
    public static final Supplier<List<OreConfiguration.TargetBlockState>> OVERWORLD_DARK_ORES = Suppliers.memoize(() -> List.of(
            ...
            OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DARK_ORE.get().defaultBlockState())));

    public static final RegistryObject<ConfiguredFeature<?, ?>> DARK_ORE = CONFIGURED_FEATURES.register("dark_ore",
            () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(OVERWORLD_DARK_ORES.get(), 7)));
